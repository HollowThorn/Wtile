...
{
    private static CompiledWindowRule Rule(string? processName = null, string? className = null, string? title = null) =>
        new()
        {
    ...
    {
        var rules = new List<CompiledWindowRule> { Rule(className: "NativeHWNDHost") };
    ...
    {
        var rules = new List<CompiledWindowRule> { Rule(processName: "chrome", title: "Netflix") };
    ...
    {
        var rules = new List<CompiledWindowRule> { Rule(className: "Foo"), Rule(className: "Bar") };
    ...
    {
        var rules = new List<CompiledWindowRule> { Rule(className: "AnyClass") };
